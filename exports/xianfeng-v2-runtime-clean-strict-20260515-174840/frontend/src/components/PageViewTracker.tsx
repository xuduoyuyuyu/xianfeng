...
function resolvePageTitle(pathname: string): string {
  ...
  if (pathname === "/reading" || pathname === "/books") return "及阅";
  if (pathname === "/materials") return "学习资料";
  if (pathname === "/planning") return "教育规划";
  if (pathname === "/topics" || /^\/topics\/[^/]+$/.test(pathname)) return "请教一下";
  if (pathname === "/worthbuy" || /^\/worthbuy\/[^/]+$/.test(pathname)) return "知物";
