...
test("buildXiaowanziMentionLinks creates layer-return links for programs topics and materials", () => {
  ...
  assert.deepEqual(links, [
    ...
    },
    {
      ...
      href: "/materials?q=09+%E7%90%86%E8%AE%BA%E7%AC%AC%E4%B8%83%E8%AF%BE+%E8%8B%B1%E8%AF%AD%E4%B8%8D%E5%A5%BD%E7%9A%84%E7%88%B8%E5%A6%88%E5%A6%82%E4%BD%95%E7%BB%99%E5%AD%A9%E5%AD%90%E5%90%AF%E8%92%99.m4a&xw_layer=1&xw_return=xiaowanzi",
      type: "material",
    },
    {
      title: "全网最好的800单词卡片完美打印版",
      href: "/materials?q=%E5%85%A8%E7%BD%91%E6%9C%80%E5%A5%BD%E7%9A%84800%E5%8D%95%E8%AF%8D%E5%8D%A1%E7%89%87%E5%AE%8C%E7%BE%8E%E6%89%93%E5%8D%B0%E7%89%88&xw_layer=1&xw_return=xiaowanzi",
      type: "material",
    },
  ]);
});
...
test("normalizeAssistantLinkDisplayText removes standalone raw link lines while keeping markdown links", () => {
  const content = [
    "👉 【请教一下】 [牛津树英语分级阅读启蒙](/topics/oxford-tree?xw_layer=1&xw_return=xiaowanzi)",
    "链接:",
    "/topics/oxford-tree?xw_layer=1&xw_return=xiaowanzi",
    "这个板块里详细介绍了牛津树体系。",
  ].join("\n");

  const normalized = normalizeAssistantLinkDisplayText(content);

  assert.match(normalized, /\[牛津树英语分级阅读启蒙\]\(\/topics\/oxford-tree\?xw_layer=1&xw_return=xiaowanzi\)/);
  assert.doesNotMatch(normalized, /链接[:：]/);
  assert.doesNotMatch(normalized, /^\s*\/topics\/oxford-tree/m);
  assert.match(normalized, /这个板块里详细介绍了牛津树体系。/);
});
