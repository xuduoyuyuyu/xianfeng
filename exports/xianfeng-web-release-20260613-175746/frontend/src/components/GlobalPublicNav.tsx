...
function Avatar({user}:{user:any}){const src=user?.avatar_image||DEFAULT_CHILD_AVATAR;return <span className="uc-av has-image"><img src={src} alt={user?.name||user?.username||"用户"} onError={(e)=>{e.currentTarget.src=DEFAULT_CHILD_AVATAR}}/></span>}
