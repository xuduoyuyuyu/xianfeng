...
import mamaResourceRoutes from "./routes/mamaResource";
import adminMamaResourceRoutes from "./routes/adminMamaResource";
import welfareRoutes from "./routes/welfare";
import adminWelfareRoutes from "./routes/adminWelfare";
...
import adminSearchAnalyticsRoutes from "./routes/adminSearchAnalytics";
import flashTestRoutes from "./routes/flashTest";
...
app.use("/api/admin/mama-resources", authenticate, requireAdmin, adminMamaResourceRoutes);
app.use("/api/admin/welfare", authenticate, requireAdmin, adminWelfareRoutes);
