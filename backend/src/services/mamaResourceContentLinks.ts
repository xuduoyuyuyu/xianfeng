...
export async function recoverLegacyContentPausedTasks() {
  return MamaResourceTask.updateMany(
    { status: "paused", pausedForContent: true },
    { $set: { status: "listed", pausedForContent: false } },
  );
}
